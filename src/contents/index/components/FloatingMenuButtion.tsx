...
function FloatingMenuButton({ toggle }: { toggle: VoidFunction }) {
    return (
        <div id="bjf-main-menu-button" onClick={toggle} className="cursor-pointer group fixed flex justify-end top-72 left-0 rounded-r-2xl shadow-md p-3 bg-white dark:bg-gray-800 transition-transform transform -ml-6 w-28 hover:translate-x-5 overflow-hidden">
