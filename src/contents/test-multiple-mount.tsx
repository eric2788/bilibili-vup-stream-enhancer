...
export const getRootContainer: () => Promise<Element> = () =>
  ...
  export const render: PlasmoRender<any> = async (
    ...
    // Render the App component into the temporary container
    renderReact(<App anchor={anchor} />, tempContainer);
  
    // Append the child nodes of the temporary container to the root container
    while (tempContainer.firstChild) {
      rootContainer.appendChild(tempContainer.firstChild);
    }
}
