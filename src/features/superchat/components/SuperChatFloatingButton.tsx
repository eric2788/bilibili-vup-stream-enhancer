    ...
    return (
        <ShadowRoot>
            ...
            <button
                ...
                className="absolute group rounded-full bg-red-600 duration-150 hover:bg-red-700 dark:bg-gray-700 dark:hover:bg-gray-800 p-3 drop-shadow-lg flex flex-col justify-center items-center gap-3 text-white">
